...
export default class  Dashyy extends Component {
 ...
 getjobinfo = async () =>{
    const d1 = await axios.get('http:/jodar-bk.herokuapp.com/user/'+this.state.jodar_id)
    const d2 = await axios.get('http:/jodar-bk.herokuapp.com/getjob/'+this.state.bid)
    const dalist = await axios.get('http:/jodar-bk.herokuapp.com/alljobslisting/'+this.state.bid)
    const daras = await axios.post('http:/jodar-bk.herokuapp.com/getratingforjob/'+this.state.bid)
    ...
    for(let i=0;i<dalist.data.dalljoblisting.length;i++)
    {
        ...
        const puser = await axios.get('http:/jodar-bk.herokuapp.com/user/'+ p["UserId"])
        const pedu = await axios.get('http:/jodar-bk.herokuapp.com/alledu/'+ p["UserId"])
        const pskill = await axios.get('http:/jodar-bk.herokuapp.com/allskill/'+ p["UserId"])
        const ppdf = await axios.get('http:/jodar-bk.herokuapp.com/downloadpdf/'+ p["UserId"])
...
ondeljob(){
    axios.delete('http:/jodar-bk.herokuapp.com/deljob/'+this.state.bid)
    .then(res => {
        console.log("ok")
...
onupjob(){
   ...
   if(c != cz && cz!="")c=cz
    ...
    console.log(newJob)
    axios.put('http:/jodar-bk.herokuapp.com/upjob/'+this.state.bid, newJob)
    .then(res => {
        console.log("ok")
        console.log(res.data)
        if(res.data.status === '201')
...
ptor(e){
    ...
    axios.put('http:/jodar-bk.herokuapp.com/ptor/'+vall)
    .then(res => {
        console.log("ok")
        console.log(res.data)
        if(res.data.status === '201')
...
ptos(e){
    let vall = e.currentTarget.value + this.state.bid
    axios.put('http:/jodar-bk.herokuapp.com/ptos/'+vall)
    .then(res => {
        console.log("ok")
        console.log(res.data)
        if(res.data.status === '201')
...
stoa(e){
    ...
    axios.put('http:/jodar-bk.herokuapp.com/stoa/'+vall)
    .then(res => {
        console.log("ok")
        console.log(res.data)
        if(res.data.status === '201')
        {
            axios.put("http:/jodar-bk.herokuapp.com/asorall/"+ zz[0]+"+"+this.state.bid)
            axios.get('http:/jodar-bk.herokuapp.com/mailit/'+emailiduser)
            .catch(err=>{
                console.log(err)
            })
            axios.get('http:/jodar-bk.herokuapp.com/mailit/'+emailiduser)
