...
export default class Dashyy extends Component {
 ...
 getjobinfo = async () =>{
    ...
    const dap = await axios.get('http://https://jodar-bk.herokuapp.com//myappli/'+this.state.jodar_id)
    // const dac = await axios.get('http://https://jodar-bk.herokuapp.com//myapplicur/'+this.state.jodar_id)
...
onapplyjob(e){
    ...
    else
    {
        ...
        axios.post('http://https://jodar-bk.herokuapp.com//jobindash', newlistjob)
            .then(res => {
                console.log("ok")
